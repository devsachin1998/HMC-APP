      ...
      <SafeAreaView style={{ flex: 1 }}>
       ...
       <CustomHeader backgroundColor='maroon' logout={true}/>
          ...
          <View style={{flexDirection:'row'}}>
            <TouchableOpacity style={[styles.iconSubConatiner,{flex:1, backgroundColor:'#ffaa11',}]}>
          ...
          <View style={{ flex: 0.4 ,backgroundColor:'skyblue'}}> 
            <Text style={styles.bottomText}>Welcome To HMC - The Council of Homoeopathic System of Medicine Gujarat</Text>
            <Text style={styles.bottomText}>Dr.J.P. Nanavati brought homoeopathy in Gujarat.He Started a homoeopathy society in 1889. He also started a charitable homoeopathy dispensary in kalupur Ahmedabad. This dispensary is still serving the large number of people.</Text>
          </View>
      </SafeAreaView>
    );
  }
