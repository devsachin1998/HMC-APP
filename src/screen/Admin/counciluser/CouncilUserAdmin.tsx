...
import CouncilUserAdminController, {Props} from './CouncilUserAdminController';
import { FAB } from 'react-native-paper';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class CouncilUserAdmin extends CouncilUserAdminController {
    ...
    return (
      <View style={{flexDirection: 'column', margin: 10}}>
        <TouchableOpacity
          ...
          onPress={() => this.updateValueById(item.UserID)}>
          <View style={{padding: 10, flex: 1}}>
            <Text style={{color: 'white'}}>{item.UserName}</Text>
          </View>
          <TouchableOpacity 
           onPress={() => { this.props.navigation.navigate('AddCouncilUserAdmin',{edit:true,item:item})}}>
          <FontAwesome5
            name={'pencil'}
            size={20}
            color="white"
...
autoCorrect={false}
          ...
          color='white'
          icon="plus"
          onPress={() => { this.props.navigation.navigate('AddCouncilUserAdmin',{edit:false})
          }}
        />
        </View>
      </SafeAreaView>
