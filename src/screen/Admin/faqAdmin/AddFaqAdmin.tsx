...
import AddAddFaqAdminController, {Props} from './AddAddFaqAdminController';
import {Dropdown} from 'react-native-element-dropdown';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class AddFaqAdmin extends AddAddFaqAdminController {
        ...
        <KeyboardAvoidingView
          ...
          <View style={{flex: 1, backgroundColor: '#fffbe7'}}>
            ...
            <View
              ...
              <TouchableOpacity
                style={{flex: 0.1}}
                onPress={() => this.props.navigation.navigate("FAQPageAdmin")}>
                <Icon
              ...
              <View style={styles.container}>
                ...
                <View style={styles.inputContainer}>
                  ...
                  <TextInput
                    ...
                    onChangeText={e => this.setState({ans: e})}
                  />
                </View>
