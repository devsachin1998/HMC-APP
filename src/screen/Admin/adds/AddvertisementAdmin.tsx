...
import AddvertisementAdminController, {Props} from './AddvertisementAdminController';
import {Dropdown} from 'react-native-element-dropdown';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class AddvertisementAdmin extends AddvertisementAdminController {
        ...
        <KeyboardAvoidingView
          ...
          <View style={{flex: 1, backgroundColor: '#fffbe7'}}>
            ...
            <View
              ...
              <TouchableOpacity
                style={{flex: 0.1}}
                onPress={() => this.props.navigation.navigate("Addvertisement")}>
                <Icon
              ...
              <View style={{flex: 1, alignSelf: 'center'}}>
                <Text
                  ...
                  {this.props.route.params.edit?'Edit Addvertisement':"Add Addvertisement"}
                </Text>
              </View>
            </View>
            <ScrollView>
