...
import AddvertisementController, {Props} from './AddvertisementController';
import { FAB } from 'react-native-paper';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class Addvertisement extends AddvertisementController {
    ...
    return (
      <View style={{flexDirection: 'column', margin: 10}}>
        <TouchableOpacity
          ...
          onPress={() => this.updateValueById(item.AdvertisementID)}>
          <View style={{padding: 10, flex: 1}}>
            <Text style={{color: 'white'}}>{item.Title}</Text>
          </View>
          <TouchableOpacity           onPress={() => { this.props.navigation.navigate('AddvertisementAdmin',{edit:true,item:item})}}>
          <FontAwesome5
            name={'pencil'}
            size={20}
            color="white"
          ...
          />
           ...
           <TouchableOpacity onPress={()=>this.showAlert(item.AdvertisementID)}>
           <FontAwesome5
            name={'trash'}
            size={20}
            color="white"
...
autoCorrect={false}
          ...
          color='white'
          icon="plus"
          onPress={() => { this.props.navigation.navigate('AddvertisementAdmin',{edit:false})
          }}
        />
        </View>
      </SafeAreaView>
