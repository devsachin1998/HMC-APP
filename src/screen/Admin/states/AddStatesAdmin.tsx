...
import AddStatesAdminController, {Props} from './AddStatesAdminController';
import {Dropdown} from 'react-native-element-dropdown';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class AddStatesAdmin extends AddStatesAdminController {
        ...
        <KeyboardAvoidingView
          ...
          <View style={{flex: 1, backgroundColor: '#fffbe7'}}>
            ...
            <View
              ...
              <TouchableOpacity
                style={{flex: 0.1}}
                onPress={() => this.props.navigation.navigate("StatesScreenAdmin")}>
                <Icon
            ...
            <ScrollView>
              <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.button}
                 onPress={() => this.props.route.params.edit ?this.updateStates():this.addStates()}
                 >
                  <Text
