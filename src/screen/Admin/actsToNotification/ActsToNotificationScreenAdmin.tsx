...
import ActsToNotificationScreenAdminController, {Props} from './ActsToNotificationScreenAdminController';
import { FAB } from 'react-native-paper';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class ActsToNotificationScreenAdmin extends ActsToNotificationScreenAdminController {
    ...
    return (
      <View style={{flexDirection: 'column', margin: 10}}>
        <TouchableOpacity
          ...
          onPress={() => this.updateValueById(item.NotificationID)}>
          <View style={{padding: 10, flex: 1}}>
            <Text style={{color: 'white'}}>{item.Title}</Text>
          </View>
          <TouchableOpacity onPress={() => { this.props.navigation.navigate('AddactsToNotificationAdmin',{edit:true,item:item})}}>
          <FontAwesome5
            name={'pencil'}
            size={20}
            color="white"
          ...
          />
           ...
           <TouchableOpacity onPress={()=>this.showAlert(item.NotificationID)}>
           <FontAwesome5
            name={'trash'}
            size={20}
            color="white"
        ...
        {item.iscollaps ? (
           ...
           <View style={{backgroundColor: '#009AEE', padding: Scale(5)}}>
    ...
    return (
      <SafeAreaView style={{flex: 1}}>
        <View style={{flex: 1, backgroundColor: '#fffbe7'}}>
          ...
          color='white'
          icon="plus"
          onPress={() => { this.props.navigation.navigate('AddactsToNotificationAdmin',{edit:false})
          }}
        />
        </View>
      </SafeAreaView>
