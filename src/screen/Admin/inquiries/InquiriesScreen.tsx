...
import InquiriesScreenController, {Props} from './InquiriesScreenController';
...
export default class InquiriesScreen extends InquiriesScreenController {
  ...
  renderItemQue = (item: any, index: number) => {
    return (
      <View style={{flexDirection: 'column'}}>
        <View>
          <TouchableOpacity
            onPress={() => this.updateValueById(item.IDP)}
            style={{
              margin: Scale(10),
            ...
            <View style={{flex:2}}>
              <Text style={{color: 'white'}}>{item.VistiorName} </Text>
            </View>
            <View
              style={{
                alignSelf: 'center',
                ...
                <TouchableOpacity style={{alignSelf: 'center',marginEnd:10}} onPress={()=>this.showAlert(item.IDP)}>
                <FontAwesome5
            name={'trash'}
            size={18}
                  color="white"
               ...
               <TouchableOpacity style={{alignSelf: 'center',marginEnd:10}} onPress={()=>this.props.navigation.navigate("AddInquiriesScreen",{item:item})}>
                <FontAwesome5
            name={'pencil'}
            size={18}
                  color="white"
          ...
          {item.iscollaps ? (
            <View
              ...
              <View style={{backgroundColor: '#009AEE', padding: Scale(10)}}>
                ...
                <Text style={{marginVertical: Scale(10), color: 'white'}}>
                  Post Date
                </Text>
              </View>
