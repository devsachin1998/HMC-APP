...
import QualificationScreenAdminController, {Props} from './QualificationScreenAdminController';
import { FAB } from 'react-native-paper';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class QualificationScreenAdmin extends QualificationScreenAdminController {
    ...
    return (
      <View style={{flexDirection: 'column', margin: 10}}>
        <TouchableOpacity
          ...
          onPress={() => this.updateValueById(item.QualificationID)}>
          <View style={{padding: 10, flex: 1}}>
            <Text style={{color: 'white'}}>{item.QualificationName}</Text>
          </View>
          <TouchableOpacity onPress={() => { this.props.navigation.navigate('AddQualificationAdmin',{edit:true,item:item})}}>
          <FontAwesome5
            name={'pencil'}
            size={20}
            color="white"
          ...
          />
           ...
           <TouchableOpacity onPress={()=>this.showAlert(item.QualificationID)}>
           <FontAwesome5
            name={'trash'}
            size={20}
            color="white"
...
autoCorrect={false}
          ...
          color='white'
          icon="plus"
          onPress={() => { this.props.navigation.navigate('AddQualificationAdmin',{edit:false})
          }}
        />
        </View>
      </SafeAreaView>
