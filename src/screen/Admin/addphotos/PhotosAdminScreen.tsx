...
import PhotosAdminController, { Props } from './PhotosAdminController';
...
export default class PhotosAdminScreen extends PhotosAdminController {
    ...
    return (
      <View style={styles.itemContainer}>
        ...
        <TouchableOpacity  style={{flex:1,alignItems:'center'}} 
          onPress={() => this.props.navigation.navigate("AddPhotosAdmin",{edit:true,item:item})}
          >
          <FontAwesome5
            name={'pencil'}
            size={25}
          ...
          />
           ...
           <TouchableOpacity  style={{flex:1,alignItems:'center'}}  onPress={()=>this.showAlert(item.GalleryDetailID)}>
           <FontAwesome5
            name={'trash'}
            size={25}
            color="white"
  ...
  render() {
    return (
      <SafeAreaView style={{flex: 1, backgroundColor: 'white'}}>
        ...
        <CustomHeader menu={true}></CustomHeader>
        ...
        {this.state.datalist.length > 0 ? (
         ...
         <FAB
          ...
          color='white'
          icon="plus"
          onPress={() => this.props.navigation.navigate("AddPhotosAdmin",{edit:false})}
        />
      </SafeAreaView>
    );
  }
