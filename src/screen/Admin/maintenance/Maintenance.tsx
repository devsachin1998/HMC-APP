...
import MaintenanceController, { Props } from './MaintenanceController';
// Customizable Area End

export default class Maintenance extends MaintenanceController {
    ...
    render() {
        return (
            ...
            <FontAwesome5 name="database"
              size={26}
            />
            <Text style={{fontWeight:'600',fontSize:Scale(16)}}>Maintenance</Text>
            </View>
