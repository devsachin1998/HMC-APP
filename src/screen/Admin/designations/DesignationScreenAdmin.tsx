...
import DesignationScreenAdminController, {Props} from './DesignationScreenAdminController';
import { FAB } from 'react-native-paper';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class DesignationScreenAdmin extends DesignationScreenAdminController {
    ...
    return (
      <View style={{flexDirection: 'column', margin: 10}}>
        <TouchableOpacity
          ...
          onPress={() => this.updateValueById(item.DesignationID)}>
          <View style={{padding: 10, flex: 1}}>
            <Text style={{color: 'white'}}>{item.DesignationName}</Text>
          </View>
          <TouchableOpacity onPress={() => { this.props.navigation.navigate('AddDesignationAdmin',{edit:true,item:item})}}>
          <FontAwesome5
            name={'pencil'}
            size={20}
            color="white"
          ...
          />
           ...
           <TouchableOpacity onPress={()=>this.showAlert(item.DesignationID)}>
           <FontAwesome5
            name={'trash'}
            size={20}
            color="white"
...
autoCorrect={false}
          ...
          color='white'
          icon="plus"
          onPress={() => { this.props.navigation.navigate('AddDesignationAdmin',{edit:false})
          }}
        />
        </View>
      </SafeAreaView>
