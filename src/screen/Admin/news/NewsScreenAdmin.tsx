...
import NewsScreenAdminController, {Props} from './NewsScreenAdminController';
import { FAB } from 'react-native-paper';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class NewsScreenAdmin extends NewsScreenAdminController {
    ...
    return (
      <View style={{flexDirection: 'column', margin: 10}}>
        <TouchableOpacity
          ...
          onPress={() => this.updateValueById(item.ScrollNewsId)}>
          <View style={{padding: 10, flex: 1}}>
            <Text style={{color: 'white'}}>{item.NewsLine}</Text>
          </View>
          <TouchableOpacity           onPress={() => { this.props.navigation.navigate('AddNewsAdmin',{edit:true,item:item})}}>
          <FontAwesome5
            name={'pencil'}
            size={20}
            color="white"
          ...
          />
           ...
           <TouchableOpacity onPress={()=>this.showAlert(item.ScrollNewsId)}>
           <FontAwesome5
            name={'trash'}
            size={20}
            color="white"
...
autoCorrect={false}
          ...
          color='white'
          icon="plus"
          onPress={() => { this.props.navigation.navigate('AddNewsAdmin',{edit:false})
          }}
        />
        </View>
      </SafeAreaView>
