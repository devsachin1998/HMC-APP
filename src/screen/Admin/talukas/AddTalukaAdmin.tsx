...
import AddTalukaAdminController, {Props} from './AddTalukaAdminController';
import {Dropdown} from 'react-native-element-dropdown';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class AddTalukaAdmin extends AddTalukaAdminController {
        ...
        <KeyboardAvoidingView
          ...
          <View style={{flex: 1, backgroundColor: '#fffbe7'}}>
            ...
            <View
              ...
              <TouchableOpacity
                style={{flex: 0.1}}
                onPress={() => this.props.navigation.navigate("TalukaScreenAdmin")}>
                <Icon
