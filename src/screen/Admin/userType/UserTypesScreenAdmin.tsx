...
import UserTypesScreenAdminController, {Props} from './UserTypesScreenAdminController';
import { FAB } from 'react-native-paper';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class UserTypesScreenAdmin extends UserTypesScreenAdminController {
    ...
    return (
      <View style={{flexDirection: 'column', margin: 10}}>
        <TouchableOpacity
          ...
          onPress={() => this.updateValueById(item.UserTypeID)}>
          <View style={{padding: 10, flex: 1}}>
            <Text style={{color: 'white'}}>{item.UserTypeName}</Text>
          </View>
          <TouchableOpacity onPress={() => { this.props.navigation.navigate('AddUserTypesAdmin',{edit:true,item:item})}}>
          <FontAwesome5
            name={'pencil'}
            size={20}
            color="white"
          ...
          />
           ...
           <TouchableOpacity onPress={()=>this.showAlert(item.UserTypeID)}>
           <FontAwesome5
            name={'trash'}
            size={20}
            color="white"
...
autoCorrect={false}
          ...
          color='white'
          icon="plus"
          onPress={() => { this.props.navigation.navigate('AddUserTypesAdmin',{edit:false})
          }}
        />
        </View>
      </SafeAreaView>
