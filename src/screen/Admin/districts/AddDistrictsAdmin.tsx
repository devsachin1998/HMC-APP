...
import AddDistrictsAdminController, {Props} from './AddDistrictsAdminController';
import {Dropdown} from 'react-native-element-dropdown';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class AddDistrictsAdmin extends AddDistrictsAdminController {
        ...
        <KeyboardAvoidingView
          ...
          <View style={{flex: 1, backgroundColor: '#fffbe7'}}>
            ...
            <View
              ...
              <TouchableOpacity
                style={{flex: 0.1}}
                onPress={() => this.props.navigation.navigate("DistrictScreenAdmin")}>
                <Icon
              ...
              <View style={styles.container}>
                <View style={styles.inputContainer}>
                  ...
                  <Dropdown
                    ...
                    onChange={item => {
                                     this.setState({selectedState: item.StateName,StateID:item.StateID});
                    }}
                  />
                ...
                <TouchableOpacity style={styles.button}
                 onPress={() => this.props.route.params.edit ?this.updateDistrict():this.addDistrict()}
                 >
                  <Text
