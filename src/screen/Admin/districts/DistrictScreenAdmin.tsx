...
import DistrictScreenAdminController, {Props} from './DistrictScreenAdminController';
import { FAB } from 'react-native-paper';
// import { Button } from "react-native-elements";
// Customizable Area End

export default class DistrictScreenAdmin extends DistrictScreenAdminController {
    ...
    return (
      <View style={{flexDirection: 'column', margin: 10}}>
        <TouchableOpacity
          ...
          onPress={() => this.updateValueById(item.DistrictID)}>
          <View style={{padding: 10, flex: 1}}>
            <Text style={{color: 'white'}}>{item.DistrictName}</Text>
          </View>
          <TouchableOpacity onPress={() => { this.props.navigation.navigate('AddDistrictsAdmin',{edit:true,item:item})}}>
          <FontAwesome5
            name={'pencil'}
            size={20}
            color="white"
          ...
          />
           ...
           <TouchableOpacity onPress={()=>this.showAlert(item.DistrictID)}>
           <FontAwesome5
            name={'trash'}
            size={20}
            color="white"
    ...
    return (
      <SafeAreaView style={{flex: 1}}>
        <View style={{flex: 1, backgroundColor: '#fffbe7'}}>
          ...
          color='white'
          icon="plus"
          onPress={() => { this.props.navigation.navigate('AddDistrictsAdmin',{edit:false})
          }}
        />
        </View>
      </SafeAreaView>
