...
export const apiFunctions = {
  ...
  galleryurl:'http://hmc.Khedutmitra.com/img/GalleryDetails/',
  login: 'otp/login',
  ...
  CollegeGalleryUpdate:'/CollegeGalleryUpdate',
  ...
  CollegeGalleryDelete:'/CollegeGalleryDelete',
  ...
  QAnsDelete:'/QAnsDelete',
  QAnsResponse:'/QAnsResponse',
  AdvertisementSelect:'/AdvertisementSelect',
  AdvertisementInsert:'/AdvertisementInsert',
  AdvertisementUpdate:'/AdvertisementUpdate',
  AdvertisementDelete:'/AdvertisementDelete',
  CollegeInsert:'/CollegeInsert',
